...
include "koneksi.php";
// Ambil data NIS yang dikirim oleh list-siswa.php melalui URL
$id = $_GET['id'];
...
if($execute){ // Cek jika proses simpan ke database sukses atau tidak
  // Jika Sukses, Lakukan :
  header("location: list-siswa.php"); // Redirect ke halaman list-siswa.php
}else{
  // Jika Gagal, Lakukan :
  echo "Data gagal dihapus. <a href='list-siswa.php'>Kembali</a>";
}
?>